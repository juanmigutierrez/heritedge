# Hunt Images — Treasure Hunt UI

These images are displayed inside the TreasureHunt UI (challenge cards and hotspot detail modals).

| File | Used in challenge | Subject |
|---|---|---|
...
- Format: JPEG
- If using stock photos (Unsplash, Wikimedia Commons), add attribution to `ATTRIBUTIONS.md`
